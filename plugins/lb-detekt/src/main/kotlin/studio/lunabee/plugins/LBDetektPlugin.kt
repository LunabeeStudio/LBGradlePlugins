 ...
 * Last modified 11/19/25, 9:07 AM
 */
    ...
    private fun setupDetektPlugin(project: Project, extension: LBDetektExtension) {
        ...
        with(extension) {
            ...
            project.project.tasks.withType<dev.detekt.gradle.Detekt>().configureEach {
                ...
                reports {
                    ...
                    checkstyle.outputLocation
                        .set(project.layout.buildDirectory.file("reports/detekt/detekt-report.xml"))
            ...
            project.project.tasks.withType<SortBuildDependenciesTask>().configureEach {
                ...
                onlyIf("Dependency sorting disabled with -P$SkipDependencySortingProperty") {
